...
CSRF_TRUSTED_ORIGINS = ["https://nptor.com", "https://www.nptor.com"]
...
MEDIA_URL = "/media/"
MEDIA_ROOT = BASE_DIR / "media" if DEBUG else Path("/home/nptorcom/public_html/media")
...
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", f"NPTOR <{EMAIL_HOST_USER}>").strip()
...
if DEBUG:
    CACHES = {"default": {"BACKEND": "django.core.cache.backends.locmem.LocMemCache", "LOCATION": "dev-cache"}}
else:
    CACHES = {"default": {"BACKEND": "django.core.cache.backends.locmem.LocMemCache", "LOCATION": "prod-cache"}}
...
LOGGING = {
    ...
    "handlers": {
        "app_file": {"level": "INFO", "class": "logging.handlers.RotatingFileHandler", "filename": LOGS_DIR / "django.log", "maxBytes": 5 * 1024 * 1024, "backupCount": 3, "formatter": "standard"},
        "error_file": {"level": "ERROR", "class": "logging.handlers.RotatingFileHandler", "filename": LOGS_DIR / "errors.log", "maxBytes": 5 * 1024 * 1024, "backupCount": 5, "formatter": "standard"},
    },
    "loggers": {
...
CKEDITOR_CONFIGS = {
    "default": {
        ...
        "height": 400,
        "width": "auto",
        "extraPlugins": ",".join(["uploadimage", "image2", "codesnippet", "autogrow"]),
        ...
        "toolbar_Custom": [
            ...
            ["Image", "UploadImage", "Table"], ["HorizontalRule", "Smiley", "SpecialChar"],
            ["CodeSnippet"], ["RemoveFormat"], ["Undo", "Redo"],
        ],
