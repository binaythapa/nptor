...
class PaymentOrder(models.Model):
    ...
    coupon = models.ForeignKey("quiz.Coupon", null=True, blank=True, on_delete=models.PROTECT, related_name="payment_orders", help_text="Coupon applied to this order, if any.")
    ...
    def clean(self):
        ...
        if self.resource_type == self.RESOURCE_SUBSCRIPTION and (
            not self.subscription_plan or not self.subscription_plan.is_all_access()
        ):
...
class PaymentWebhookEvent(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=["gateway", "event_id"], name="unique_payment_webhook_event"),
        ]
