...
#
# IMPORTANT:
# Keep this AFTER the wildcard imports above.
# This prevents another module from overwriting these names.
# ============================================================
...
urlpatterns = [
    ...
    path(
        "practice/answer/ajax/",
        practice_answer_ajax,
        name="practice_answer_ajax",
    ),
    ...
    # DO NOT add notification_views routes here.
    # ========================================================
   ...
   path(
    ...
    path(
        "staff/questions/<int:pk>/review/",
        question_review,
        name="question_review",
    ),

    path(
        "ajax/question/toggle/",
        toggle_question_active,
        name="toggle_question_active",
    ),

    path(
        "ajax/question/delete/",
    ...
    path(
        "study-plan/",
        study_plan_dashboard,
        name="study_plan_dashboard",
    ),

    path(
        "study-plan/practice/",
        study_plan_practice,
        name="study_plan_practice",
    ),
    ...
    path(
        "study-plan/clone/<int:plan_id>/",
        clone_study_plan,
        name="clone_study_plan",
    ),
