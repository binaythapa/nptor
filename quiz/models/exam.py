...
class Exam(models.Model):
    ...
    Exams are content resources, not independently sellable products. Course
    and Track relationships own their inclusion and ordering; subscription
    access is inherited from those parent products.
    """
    ...
    level = models.PositiveIntegerField(default=1, db_index=True, help_text="Difficulty/level of this exam.")
    ...
    @property
    def price(self):
        return self._legacy_price if self._legacy_price is not None else 0
