...
class LearningCatalogServiceTests(TestCase):
    def setUp(self):
        ...
        self.snowflake = Domain.objects.create(
            name="Snowflake",
            slug="snowflake",
            is_active=True,
        )
        ...
        self.snowflake_category = Category.objects.create(
            name="Snowflake Core",
            slug="snowflake-core",
            domain=self.snowflake,
            is_active=True,
        )
        self.aws_category = Category.objects.create(
            name="AWS Core",
            slug="aws-core",
            domain=self.aws,
            is_active=True,
    ...
    def test_builds_active_domains_and_derives_course_exam_and_track_domains(self):
        course = Course.objects.create(
            ...
            category=self.snowflake_category,
            level="beginner",
            is_public=True,
            is_published=True,
        ...
        Exam.objects.create(
            title="AWS Exam",
            primary_category=self.aws_category,
            question_count=10,
            duration_seconds=1800,
            is_published=True,
            is_free=True,
    ...
    def test_excludes_inactive_domains_and_non_public_resources(self):
        inactive = Domain.objects.create(
            name="Legacy",
            slug="legacy",
            is_active=False,
        )
        ...
        Exam.objects.create(
            title="Legacy Exam",
            primary_category=inactive_category,
            question_count=10,
            duration_seconds=1800,
            is_published=True,
            is_free=True,
