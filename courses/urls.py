...
urlpatterns = [
    ...
    path("certificate/<str:certificate_id>/", certificate_verify, name="certificate_verify"),
    path("certificate/<str:certificate_id>/download/", certificate_download, name="certificate_download"),
    ...
    path("<slug:slug>/learn/<int:lesson_id>/complete/", lesson_course_access_required(student_views.mark_lesson_completed), name="mark_lesson_completed"),
    path("<slug:slug>/certificate/pdf/", course_entitlement_required(student_views.download_certificate_pdf), name="course_certificate_pdf"),
    path("video/progress/", video_progress_access_required(student_views.track_video_progress), name="track_video_progress"),
    path("subscribe/<int:course_id>/", course_checkout, name="subscribe_course"),
    path("<slug:slug>/", course_detail_access_required(student_views.course_detail), name="course_detail"),
    path("instructor/dashboard/", instructor_dashboard_access_required(instructor_dashboard), name="instructor_dashboard"),
    path("instructor/course/create/", course_creation_access_required(instructor_views.course_create), name="course_create"),
    ...
    path("admin/course/<slug:slug>/request-changes/", admin_views.request_changes_view, name="admin-request-course-changes"),
