...
document.addEventListener("DOMContentLoaded", () => {
    ...
    /* ========================================================
       HEADER — match Practice Questions
       ======================================================== */
    ...
    /* ========================================================
       FILTER — same collapsed panel proportions as Practice
       ======================================================== */
    ...
    if (filter) {
        ...
        if (filterHeader) {
            ...
            filterHeader.removeAttribute("onclick");
    ...
    /* ========================================================
       PROGRESS — replace Express stats row with Practice bar
       ======================================================== */
    ...
    /* Keep hidden legacy values available to the existing Express logic. */
    ...
    /* ========================================================
       QUESTION CARD — same meta/text/choice structure as Practice
       ======================================================== */
    if (questionCard) {
        ...
        if (buttonGroup) {
            ...
            if (!buttonGroup.querySelector("#expressSkipBtn")) {
                const skip = document.createElement("button");
                skip.type = "button";
                skip.id = "expressSkipBtn";
                skip.className = "practice-btn practice-btn-secondary";
                ...
                buttonGroup.insertBefore(skip, reset || submit || null);
            }
        }
    }

    /* ========================================================
       LIVE EXPRESS VALUES → Practice progress/meta
       ======================================================== */
    const syncProgress = () => {
    ...
    /* ========================================================
       CHOICES — match Practice compact choices
       ======================================================== */
    const markChoices = () => {
    ...
    if (!document.getElementById("practice-express-ui-style")) {
        ...
        style.textContent = `
            ...
            .practice-express-page .practice-express-filter .practice-filter-header {
                display: flex;
                align-items: center;
                justify-content: space-between;
                width: 100%;
            ...
            .practice-express-page .practice-filter-heading .practice-filter-icon {
                display: none;
            }

            .practice-express-page .practice-filter-hint,
            .practice-express-page #filterHint {
            ...
            .practice-express-page .practice-progress {
                display: block;
                width: 100%;
                margin: 18px 0 20px;
                box-sizing: border-box;
            ...
            .practice-express-page .practice-progress-top {
                display: flex;
                align-items: center;
                justify-content: space-between;
                margin-bottom: 7px;
            ...
            .practice-express-page .practice-progress-top span {
                color: var(--muted-text-color, #6b7280);
            }

            .practice-express-page .practice-progress-top strong {
                color: var(--text-color, #374151);
            }

            .practice-express-page .practice-progress-track {
                width: 100%;
                height: 5px;
                overflow: hidden;
                border-radius: 999px;
            ...
            .practice-express-page .practice-progress-bar {
                height: 100%;
            ...
            .practice-express-page .practice-question-meta {
                display: flex;
                align-items: center;
                justify-content: space-between;
                gap: 12px;
            ...
            .practice-express-page .practice-question-type {
                display: inline-flex;
                align-items: center;
                padding: 4px 8px;
                border-radius: 999px;
            ...
            .practice-express-page .practice-question-text {
                margin: 0 0 20px;
                color: var(--text-color, #1f2937);
                font-size: 1.05rem;
                font-weight: 400;
            ...
            .practice-express-page .practice-card-actions {
                display: flex;
                align-items: center;
                gap: 8px;
                margin-top: 4px;
            ...
            .practice-express-page .practice-btn {
                display: inline-flex;
                align-items: center;
                justify-content: center;
                min-height: 42px;
            ...
            .practice-express-page .practice-btn-primary {
                color: #fff;
                border-color: var(--primary-color, #3273dc);
                background: var(--primary-color, #3273dc);
            }

            .practice-express-page .practice-btn-secondary {
                color: var(--text-color, #374151);
                background: var(--surface-color, #fff);
            }
