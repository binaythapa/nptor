...
class StudentAcademicModelTests(TestCase):
    ...
    def test_active_enrollment_is_unique_for_an_academic_year(self):
        ...
        StudentEnrollment.objects.create(student=student, academic_year=year, class_section=section)
        second = StudentEnrollment(student=student, academic_year=year, class_section=section)
