...
public_patterns = [
    path("workspace/", organization_workspace, name="workspace"), path("my-courses/", my_courses, name="my_courses"), path("learning/", organization_learning, name="learning"), path("student-profile/", organization_student_profile, name="student_profile"), path("student-profile/edit/", organization_student_profile_edit, name="student_student_profile_edit"), path("student-profile/<int:student_id>/", organization_student_profile_admin, name="student_profile_admin"), path("student-profile/<int:student_id>/edit/", organization_student_profile_admin_edit, name="student_profile_admin_edit"), path("", org_public_page, name="public_page"),
]
