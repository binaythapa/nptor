...
from organizations.views.admin.students import org_students, org_student_add, org_student_update_role, org_student_remove, org_student_detail
...
admin_patterns = [
    ...
    path("students/", org_students, name="students"), path("students/add/", org_student_add, name="student_add"), path("students/<int:student_id>/", org_student_detail, name="student_detail"), path("students/<int:member_id>/role/", org_student_update_role, name="student_role"), path("students/<int:member_id>/remove/", org_student_remove, name="student_remove"),
    path("academic/", academic_dashboard, name="academic"), path("academic/years/add/", academic_year_create, name="academic_year_create"), path("academic/classes/add/", class_create, name="academic_class_create"), path("academic/sections/add/", section_create, name="academic_section_create"), path("academic/sections/<int:section_id>/teachers/add/", teacher_assign, name="teacher_assign"), path("academic/students/<int:student_id>/enroll/<int:section_id>/", student_enroll, name="student_enroll"), path("academic/sections/<int:section_id>/assign-resource/", class_assignment_create, name="class_assignment_create"),
